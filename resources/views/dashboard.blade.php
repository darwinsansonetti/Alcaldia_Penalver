	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 style="color:black;" class="modal-title fs-5" id="solicitudLabel">Galeria</h5>
			</div>
			<div class="modal-body">
				<div class="container-fluid">		</br>			
					<form id="galeriaForm" enctype="multipart/form-data">
						...
						<button type="button" onclick="guardar_galeria()" class="btn btn-secondary">Guardar</button>
					</form>
				</div>	</br>
			</div>
		</div>
